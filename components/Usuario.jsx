...
mutation EliminarUsuario($eliminarUsuarioId: ID!) {
...
const Usuario=({usuario})=>{
    ...
    const [ eliminarUsuario ] = useMutation(ELIMINAR_USUARIO,{
        update(cache){
            ...
            cache.writeQuery({
                ...
                data: {
                    obtenerUsuarios: obtenerUsuarios.filter(usuario => usuario.id != id)
                }
            })
        }
    });
    ...
    return(
        <tr className="border-b border-neutral-200 dark:border-white/10 bg-orange-50" >
                  ...
                  <td className="whitespace-nowrap  px-6 py-4 font-medium uppercase  ">{apellido}</td>
                  <td className="whitespace-nowrap  px-6 py-4 font-medium   ">{email}</td>
                  <td className="whitespace-nowrap  px-6 py-4 font-medium uppercase  ">{rol}</td>
