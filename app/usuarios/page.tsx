        ...
        <thead className="bg-gray-950">
            ...
            <tbody className="overflow-y-scroll h-1/2">
              {data.obtenerUsuarios.map((usuario:any)=>(
                <tr className="border-b border-neutral-200 dark:border-white/10 bg-orange-50" key={usuario.id}>
                  <td className="whitespace-nowrap  px-6 py-4 font-medium uppercase  ">{usuario.nombre}</td>
                  <td className="whitespace-nowrap  px-6 py-4 font-medium uppercase  ">{usuario.apellido}</td>
                  <td className="whitespace-nowrap  px-6 py-4 font-medium   ">{usuario.email}</td>
                  <td className="whitespace-nowrap  px-6 py-4 font-medium uppercase  ">{usuario.rol}</td>
